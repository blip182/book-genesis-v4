...
*Draft v2. v1 written to the chapter-03 register from the beat sheet; v2 (round 4) corrects why she chose contract work (to own her work and hold the autonomy to accept or decline structure and workload), makes the closing mid-loop real and specific (right now the shift is a NARROWING of career focus driven by skill development, which adds the insight that the loop runs both directions, opening and closing), and softens an invented outside-voice ("people have told me scattered" to "I know how that can look"). Nothing is final until Jena signs off. Remaining invented texture flagged below.*
